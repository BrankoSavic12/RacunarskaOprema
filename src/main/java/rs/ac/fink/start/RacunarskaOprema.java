...
public class RacunarskaOprema {
    public static void main(String[] args) {
        try {
            ...
            User newUser = new User(0, "Jovan Jovanovic44", "jjovan", "jovan.jovanovic@example.com", "1988-03-12", 1000, 5000);
            ...
            Product newProduct = new Product(0, "Grafička karta", 7500, "Computer Hardware", 5);
